...
export default {
  ...
  methods: {
    ...
    async function_update(name, weight, age, height, profession, gender) {
      return await this.function_query("PUT", "user", {
        name,
        weight,
        age,
        height,
    ...
    async updateProfile() {
      ...
      if (this.typeAcc === 2) {
        if (
          (document.getElementById("radio_N").checked ||
            document.getElementById("radio_PT").checked) &&
          this.typeAcc === 2
        ) {
      ...
      const response = await this.function_update(
        this.nameU,
        this.weightU,
        this.ageU,
        this.heightU,
      ...
      <div>
        <div id="div_upForm">
          ...
          <button
            id="but_pi"
            :class="{
              but_pi_basic: typeAcc === 0,
              but_pi_pro: typeAcc === 1,
              but_pi_work: typeAcc === 2,
            }"
            @click="updateProfile"
            v-if="!isStatsPage"
          >
        ...
        <form>
          <div id="div_input_form">
            ...
            <div class="div_inner_form">
              ...
              <h2 class="h2_form" style="width: auto" v-if="typeAcc === 0">
                Patient Basic
              </h2>
              <h2 class="h2_form" style="width: auto" v-if="typeAcc === 1">
                Patient Pro
              </h2>
              <h2 class="h2_form" style="width: auto" v-if="typeAcc === 2">
                Professionals
              </h2>
            </div>
            <h2 id="h2_profile" style="margin-top: -0.2vh">
            ...
            <div id="div_downForm">
              <div class="div_inner_form">
                ...
                <input
                  ...
                  :disabled="isStatsPage"
                />
                <h2 class="h2_form_down" style="width: 20%; margin-left: 1vw">
                  Height:
                </h2>
                <input
                  class="input_form_down"
